...
int main(void)
{
  ...
  while (1)
  {
    if(!did_setup) { continue; }

    if( SHT40_Measure(&hi2c1, &measurement, MED_PRECISION) == HAL_ERROR ) {
        printf("Error getting measurement from SHT40; retrying in 5 seconds\r\n");
    } else {
        printf("== SHT40 Sensor Readings ==\r\n");
        printf("Temperature: %.2f degrees C\r\n", measurement.temperature);
        printf("Relative Humidity: %.2f%%\r\n", measurement.rel_humidity);
    }
    /* USER CODE END WHILE */
